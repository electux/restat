...
release = u'https://github.com/vroncevic/restat/releases/tag/v1.0.0'
...
man_pages = [
    (master_doc, 'restat', u'restat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'atled', u'atled Documentation',
     author, 'atled', 'One line description of project.',
     'Miscellaneous'),
]
